...
//   // 🔹 Category Filter
//   const categoryResult = userData.filter((item) =>
//     item.category === cate
//   );

//   // 🔹 Search Filter (id ya title se)
//   const searchResult = userData.filter((item) =>
//     // item.id.toString().includes(cate) ||
//     item.id == cate ||
//     item.title?.toLowerCase().includes(cate.toLowerCase())
//   );

//   // 🔹 Decide kya show karna hai
//   if (categoryResult.length > 0) {
//     setfiltercategory(categoryResult);
//     // settrueshow(true);
//   } else if (searchResult.length > 0) {
//     setfiltercategory(searchResult);
//     settrueshow(true);
//   } else {
//     // setfiltercategory([]);
//     settrueshow(false);
...
// const dispatch=useDispatch();
  ...
  return (
    <>
      ...
      {/* <Header proCategory={createCategory}  /> */}
...
<div className="search-box">
    ...
    {trueshow ? (
      <>
      <div className='heading'><h2>Our Best Products</h2></div>
